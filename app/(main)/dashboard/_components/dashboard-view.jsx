...
//   // Salary data mapping with safe fallback
//   const salaryData = (insights.salaryRanges || []).map((range) => ({
//     name: range.role,
//     min: range.min / 1000,
//     max: range.max / 1000,
...
//     insights.lastUpdated && isValid(new Date(insights.lastUpdated))
//       ? format(new Date(insights.lastUpdated), "dd/MM/yyyy")
//       : "Unknown";

//   const nextUpdateDistance =
//     insights.nextUpdate && isValid(new Date(insights.nextUpdate))
